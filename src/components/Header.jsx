...
export default function Header() {
  return (
    <header className="shadow sticky bg-zinc-800 w-full z-50 top-0">
      <nav className="flex justify-center items-center border-b-yellow-600 py-2.5">
        <div className="flex justify-between items-center w-full mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          {/* Logo Section */}
          <a href="#">
